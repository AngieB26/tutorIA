...
if (!process.env.DATABASE_URL) {
  console.error('DATABASE_URL no está definida. Verificando .env.local...');
  const fs = require('fs');
...
async function seed() {
  ...
  try {
    ...
    console.log(`✅ ${estudiantesInfo.length} estudiantes creados`);
    ...
    console.log(`✅ ${tutoresData.length} tutores creados`);
    ...
    console.log(`✅ ${seedData.length} incidencias creadas`);
    ...
    console.log(`✅ ${notasData.length} notas creadas`);
    ...
    console.log(`✅ ${clasesSeed.length} clases creadas`);
